...
> ⚠️ **Note**: The following translations were generated by AI (Google Gemini). Please refer to the [English version](https://github.com/AyumuOkumura/SeuratVizHelper/blob/master/README.md#bring-scanpy-style-stacked-violin-plots-to-seurat) for the most accurate technical specifications.
