...
このドキュメントでは、StackVlnパッケージの`StackVln`関数を使用して、
...
このドキュメントでは、StackVlnパッケージを使用して：

1. PBMCデータセットを読み込み
2. マーカー遺伝子を指定
3. StackVlnプロットを作成

する方法を示しました。詳細なドキュメントは[GitHubリポジトリ](https://github.com/AyumuOkumura/StackVln)をご覧ください。
