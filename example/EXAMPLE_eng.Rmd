---
title: "StackVln Example: Stacked Violin Plot"
author: "StackVln"
date: "`r Sys.Date()`"
output: 
  html_document:
...
This document demonstrates how to create a Scanpy-style stacked violin plot using the `StackVln` function from the StackVln package.
...
This document demonstrated how to use the StackVln package to:

1. Load a PBMC dataset
2. Specify marker genes
3. Create a StackVln plot

For detailed documentation, see the [GitHub repository](https://github.com/AyumuOkumura/StackVln).
